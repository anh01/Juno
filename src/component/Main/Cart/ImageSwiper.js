...
const sp2 = require('../../../media/productImage/sp1.jpg');
const sp3 = require('../../../media/productImage/sp1.jpg');

const imgList = [sp1, sp2, sp3];
...
const Viewer = props => (
  <Swiper index={props.index} style={styles.wrapper} renderPagination={renderPagination}>
    {
